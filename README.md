...
- 每张图的主题、认知锚点、核心意思、可视动作、角色分工和中文标注建议
...
这张设定图只用于校准角色形象，不是正文插图示例。Figthus 原生正文插图图库将在 Stage 2 补齐。
...
每张图写清楚：放在哪段后、主题、认知锚点、可视动作、烂笔头做什么、破橡皮做什么、建议中文标注词。
...
7. 分配角色：烂笔头制造痕迹，破橡皮制造空白或证据判断
8. 每张图单独调用图像模型生成
9. 按 QA checklist 检查：白底、留白、角色分工、残损状态、短中文标注、非 PPT 感、非旧案例复刻
...
- 烂笔头和破橡皮必须承担生成/修正关系；如果去掉角色画面仍然完全成立，说明角色太装饰了。
- 角色设定图只用于校准形象，不要复刻构图。
